...
import 'package:tfg_v3/src/features/generators/image_generator/create_button.dart';
import 'package:tfg_v3/src/features/generators/image_generator/image_screen_subtitles.dart';
import 'package:tfg_v3/src/features/generators/image_generator/text_field_prompt.dart';

import 'package:tfg_v3/src/utils/constants/bool_constants.dart';
...
class _ImageGeneratorScreenState extends State<ImageGeneratorScreen> {
  ...
  void initState() {
    ...
    _itemTypesStyle = YTexts.tItemTypesStyle;
    _itemStatusColors = YBools.tItemStatusColors;
    _itemTypesColors = YTexts.tItemTypesColors;
    super.initState();
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const ImageScreenSubtitles(title: YTexts.tImageScreenSubtitlesStyles),
              addVerticalSpace(15.0),
              gridViewStyles(context),
              addVerticalSpace(30.0),
              const ImageScreenSubtitles(title: YTexts.tImageScreenSubtitlesColors),
              addVerticalSpace(15.0),
