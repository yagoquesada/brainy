...
class LongPressImage extends StatelessWidget {
  ...
  void _showPopupMenu(BuildContext context) {
    final popupItems = [YTexts.fullScreen, YTexts.downloadImage, YTexts.close];
  ...
  void _handlePopupSelection(BuildContext context, String value) {
    switch (value) {
      case YTexts.fullScreen:
        YHelperFunctions.navigateToScreen(context, FullImageScreen(imageUrl: imageUrl));
        break;
      case YTexts.downloadImage:
