...
import 'package:tfg_v3/src/app/authentication/pages/landing_screen.dart';
import 'package:tfg_v3/src/app/authentication/pages/mail_verification.dart';
import 'package:tfg_v3/src/app/authentication/repositories/exceptions.dart';
...
class YAuthenticationRepository extends GetxController {
  ...
  Future<void> createUserWithEmailAndPassword(String email, String password, String name) async {
    try {
      ...
      _firebaseUser.value != null ? Get.offAll(() => const MenuScreen()) : Get.to(() => const LandingScreen());
