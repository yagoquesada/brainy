      ...
      children: [
        ...
        RichText(
          text: TextSpan(
            children: [
              TextSpan(
                text: YTexts.haveAnAccount,
                style: Theme.of(context).textTheme.bodyLarge,
              ),
              TextSpan(
                text: YTexts.loginHere,
                style: Theme.of(context).textTheme.bodyLarge!.copyWith(color: YColors.primary),
                recognizer: TapGestureRecognizer()..onTap = () => YHelperFunctions.navigateToScreenAndReplace(context, const LoginScreen()),
              ),
            ],
          ),
        ),
